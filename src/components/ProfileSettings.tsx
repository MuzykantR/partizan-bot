...
import { ShieldCheck, MessageSquare, Share2, Check, Copy, Users, Award, User as UserIcon, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-5 pb-24 pt-1">
      ...
      <button
        ...
        className="w-full pv-card p-4 flex items-center justify-between transition-all hover:bg-[#1A1A1C] active:scale-[0.99]"
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[#1A1A1C] border border-[#3A3A3D] text-[#C8372D] flex items-center justify-center shrink-0">
            <FileText className="w-5 h-5 text-[#C8372D]" />
          </div>
          <div className="text-left">
            <div className="text-base font-bold text-[#F4F0EA]">Публичная оферта</div>
            <div className="text-xs text-[#9E9B97]">Пользовательское соглашение</div>
          </div>
        </div>
      </button>
